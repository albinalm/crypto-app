...
namespace CryptoInstallerWindows
{
    public class MainWindow : Window
    {
        ...
        private Bitmap ReadEmbeddedResourceImage(string resourceName)
        {
            ...
            using (var stream = assembly.GetManifestResourceStream("PrivateerInstallerWindows.Resources." + resourceName))
            {
        ...
        {
            using (var resource = Assembly.GetExecutingAssembly().GetManifestResourceStream("PrivateerInstallerWindows.InstallData.install_windows.zip"))
            {
        ...
        private void Extract()
        {
            ...
            using (var resource = Assembly.GetExecutingAssembly().GetManifestResourceStream("PrivateerInstallerWindows.InstallData.icon.ico"))
            {
        ...
        private void Windows_WriteShortcut(string path, string arguments = "")
        {
            ...
            shortcut.TargetPath = txt_path.Text + @"/Privateer.exe";                 // The path of the file that will launch when the shortcut is run

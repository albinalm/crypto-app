...
namespace PrivateerInstallerLinux
{
    public class MainWindow : Window
    {
        ...
        private Bitmap ReadEmbeddedResourceImage(string resourceName)
        {
            ...
            using (var stream = assembly.GetManifestResourceStream("PrivateerInstallerLinux.Resources." + resourceName))
            {
        ...
        {
            using(var resource = Assembly.GetExecutingAssembly().GetManifestResourceStream("PrivateerInstallerLinux.InstallData.core.zip"))
            {
            ...
            if (kde)
            {
                using(var resource = Assembly.GetExecutingAssembly().GetManifestResourceStream("PrivateerInstallerLinux.InstallData.dolphin.zip"))
                {

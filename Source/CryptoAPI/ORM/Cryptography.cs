    ...
    public static class Cryptography
    {
        ...
        public static class Encryption
        {
            public static void EncryptFile(string inputFile, string outputFile)
            {
                ...
                var salt = Encoding.ASCII.GetBytes(Environment.UserName); //Salt is your username in bytes
                ...
                using var stream = new CryptoStream(ms, rm.CreateEncryptor(), CryptoStreamMode.Write);
